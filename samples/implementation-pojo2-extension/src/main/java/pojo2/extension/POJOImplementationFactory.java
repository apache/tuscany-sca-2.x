 ...
 */
public class POJOImplementationFactory implements ImplementationProviderFactory<POJOImplementation> {
    
    public POJOImplementationFactory(ExtensionPointRegistry registry) {
    }
