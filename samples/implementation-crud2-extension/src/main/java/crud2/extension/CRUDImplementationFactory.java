 ...
 * or policy sets
 */
public class CRUDImplementationFactory implements ImplementationProviderFactory<CRUDImplementation> {
    
    public CRUDImplementationFactory(ExtensionPointRegistry registry) {
    }
