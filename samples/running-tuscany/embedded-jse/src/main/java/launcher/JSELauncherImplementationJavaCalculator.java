...
public class JSELauncherImplementationJavaCalculator {
    ...
    public void launchImplementationJavaCalculator(){
        Node node = NodeFactory.newInstance().createNode(new Contribution("c1", "../../learning-more/implementation-java/contribution-calculator/target/sample-contribution-implementation-java-calculator.jar"));
        node.start();
