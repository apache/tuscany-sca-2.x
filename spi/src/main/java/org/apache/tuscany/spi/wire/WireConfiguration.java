...
/**
 * Contains configuration for a wire, including its invocation chains. Invocation chains are accessed from the
 * collection of {@link InvocationConfiguration}s keyed by operation on the service specified by the source
 * reference or target service. <code>WireConfiguration</code> subtypes distinguish between source and target
 * sides of a wire and hence return corresponding <code>InvocationChain</code> subtypes.  Operations are
 * represented using JDK reflection, i.e. as a <code>Method</code> corresponding to the Java interface
...
public abstract class WireConfiguration<T extends InvocationConfiguration> {
     ...
     */
    public WireConfiguration(QualifiedName targetName, ClassLoader proxyClassLoader) {
