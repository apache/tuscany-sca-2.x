 ...
 * <ul>
 *   <li>{@link org.apache.tuscany.core.system.assembly.sdo.impl.SystemBindingImpl#getAny <em>Any</em>}</li>
 *   <li>{@link org.apache.tuscany.core.system.assembly.sdo.impl.SystemBindingImpl#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SystemBindingImpl extends BindingImpl implements SystemBinding {
    ...
    protected EClass eStaticClass() {
        return SystemAssemblyPackage.eINSTANCE.getSystemBinding();
    }
    ...
    public Sequence getAny() {
        if (any == null) {
            any = new BasicESequence(new BasicFeatureMap(this, SystemAssemblyPackage.SYSTEM_BINDING__ANY));
        }
        return any;
    }
    ...
    public Sequence getAnyAttribute() {
        if (anyAttribute == null) {
            anyAttribute = new BasicESequence(new BasicFeatureMap(this, SystemAssemblyPackage.SYSTEM_BINDING__ANY_ATTRIBUTE));
        }
        return anyAttribute;
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
        if (featureID >= 0) {
            switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
                case SystemAssemblyPackage.SYSTEM_BINDING__ANY:
                return ((InternalEList)((ESequence)getAny()).featureMap()).basicRemove(otherEnd, msgs);
                case SystemAssemblyPackage.SYSTEM_BINDING__ANY_ATTRIBUTE:
    ...
    public Object eGet(EStructuralFeature eFeature, boolean resolve) {
        switch (eDerivedStructuralFeatureID(eFeature)) {
            case SystemAssemblyPackage.SYSTEM_BINDING__URI:
                return getUri();
            case SystemAssemblyPackage.SYSTEM_BINDING__ANY:
