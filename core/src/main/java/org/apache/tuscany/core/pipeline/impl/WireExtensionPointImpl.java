 ...
 *
 */
public class WireExtensionPointImpl implements MessageHandler {
     ...
     * Constructor
     */
    public WireExtensionPointImpl() {
        super();
    }

    public boolean processMessage(Message message) {
        // Route to the wire target stage
     ...
     */
    public void setSource(EndpointReference source) {
        this.source = source;
    }
