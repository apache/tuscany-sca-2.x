 ...
 * <ul>
 * <li>{@link BodyElement#getAny <em>Any</em>}</li>
 * <li>{@link BodyElement#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 * </p>
 *
 * @model extendedMetaData="name='Body' kind='elementOnly'"
 * @generated
 * @see MessageElementPackage#getBodyElement()
 */
public interface BodyElement {
     ...
     * @generated
     * @see MessageElementPackage#getBodyElement_Any()
     */
    Sequence getAny();
     ...
     * @generated
     * @see MessageElementPackage#getBodyElement_AnyAttribute()
     */
