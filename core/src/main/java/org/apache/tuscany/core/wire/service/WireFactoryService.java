...
/**
 * Implementations provide a system service that creates {@link org.apache.tuscany.spi.wire.SourceWireFactory}s
 * and {@link org.apache.tuscany.spi.wire.TargetWireFactory}s. This service is used by {@link
 ...
 * {@link org.apache.tuscany.spi.wire.WireFactory}s for their references and target services. This service is typically autowired
 * to.
 *
 * @version $$Rev$$ $$Date$$
 */
public interface WireFactoryService {
     ...
     * @throws org.apache.tuscany.spi.builder.BuilderConfigException
     */
