 ...
 *
 */
public class ExternalServiceBindingExtensionPointImpl implements MessageHandler {
     ...
     * Constructor
     */
    public ExternalServiceBindingExtensionPointImpl() {
        super();
    }
     ...
     */
    public MessageHandler getExternalService() {
