 ...
 * <ul>
 * <li>{@link BodyElementImpl#getAny <em>Any</em>}</li>
 * <li>{@link BodyElementImpl#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class BodyElementImpl extends EDataObjectImpl implements BodyElement {
    /**
    ...
    protected EClass eStaticClass() {
        return MessageElementPackage.eINSTANCE.getBodyElement();
    }
    ...
    public Sequence getAny() {
        if (any == null) {
            any = new BasicESequence(new BasicFeatureMap(this, MessageElementPackage.BODY_ELEMENT__ANY));
        }
        return any;
    }
    ...
    public Sequence getAnyAttribute() {
        if (anyAttribute == null) {
            anyAttribute = new BasicESequence(new BasicFeatureMap(this, MessageElementPackage.BODY_ELEMENT__ANY_ATTRIBUTE));
        }
        return anyAttribute;
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
        if (featureID >= 0) {
            ...
            case MessageElementPackage.BODY_ELEMENT__ANY:
                return ((InternalEList) ((ESequence) getAny()).featureMap()).basicRemove(otherEnd, msgs);
            case MessageElementPackage.BODY_ELEMENT__ANY_ATTRIBUTE:
