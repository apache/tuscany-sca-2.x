 ...
 *
 */
public class WireSourceExtensionPointImpl implements MessageHandler {
     ...
     * Constructor
     */
    public WireSourceExtensionPointImpl() {
        super();
    }

    public boolean processMessage(Message message) {
        // Route to the wire stage
        message.setTo(wire);
