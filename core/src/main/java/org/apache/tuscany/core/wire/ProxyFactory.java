 ...
 * implement the interface required by the reference and pass wire messages down source- and target-side
 * wire chains for processing. These source- and target-side wire chains will be derived from metadata
 ...
 * case, the proxy will implement the requested service interface but will only contain a target-side wire chain.
 *
 * @version $Rev$ $Date$
 */
public interface ProxyFactory<T> {
     ...
     * construction of the proxy configuration is complete, including linking of source and target wire chains.
     * 
