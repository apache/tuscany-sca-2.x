...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Header Element</b></em>'.
 * <!-- end-user-doc -->
 * <p/>
 * The following features are implemented:
 * <ul>
 * <li>{@link HeaderElementImpl#getAny <em>Any</em>}</li>
 * <li>{@link HeaderElementImpl#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class HeaderElementImpl extends EDataObjectImpl implements HeaderElement {
    /**
    ...
    protected EClass eStaticClass() {
        return MessageElementPackage.eINSTANCE.getHeaderElement();
    }
    ...
    public Sequence getAny() {
        if (any == null) {
            any = new BasicESequence(new BasicFeatureMap(this, MessageElementPackage.HEADER_ELEMENT__ANY));
        }
        return any;
    }
    ...
    public Sequence getAnyAttribute() {
        if (anyAttribute == null) {
            anyAttribute = new BasicESequence(new BasicFeatureMap(this, MessageElementPackage.HEADER_ELEMENT__ANY_ATTRIBUTE));
        }
        return anyAttribute;
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
        if (featureID >= 0) {
            ...
            case MessageElementPackage.HEADER_ELEMENT__ANY:
                return ((InternalEList) ((ESequence) getAny()).featureMap()).basicRemove(otherEnd, msgs);
            case MessageElementPackage.HEADER_ELEMENT__ANY_ATTRIBUTE:
