 ...
 *
 */
public class ExternalServiceExtensionPointImpl implements MessageHandler {
     ...
     * Constructor
     */
    public ExternalServiceExtensionPointImpl() {
        super();
    }

    public boolean processMessage(Message message) {
        // Route to the binding stage
        message.setTo(binding);
