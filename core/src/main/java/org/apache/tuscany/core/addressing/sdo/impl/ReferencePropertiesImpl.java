 ...
 * <ul>
 * <li>{@link ReferencePropertiesImpl#getAny <em>Any</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ReferencePropertiesImpl extends EDataObjectImpl implements ReferenceProperties {
    /**
    ...
    protected EClass eStaticClass() {
        return AddressingElementPackage.eINSTANCE.getReferenceProperties();
    }
    ...
    public Sequence getAny() {
        if (any == null) {
            any = new BasicESequence(new BasicFeatureMap(this, AddressingElementPackage.REFERENCE_PROPERTIES__ANY));
        }
        return any;
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
        if (featureID >= 0) {
            ...
            case AddressingElementPackage.REFERENCE_PROPERTIES__ANY:
