 ...
 * @generated
 */
public class JavaAssemblyPackageImpl extends EPackageImpl implements JavaAssemblyPackage {
    /**
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     ...
     * @see org.apache.tuscany.container.java.assembly.sdo.JavaAssemblyPackage#eNS_URI
     * @see #init()
     */
    private JavaAssemblyPackageImpl() {
        super(eNS_URI, JavaAssemblyFactory.eINSTANCE);
    }
     ...
     */
    public static JavaAssemblyPackage init() {
        if (isInited) return (JavaAssemblyPackage) EPackage.Registry.INSTANCE.getEPackage(JavaAssemblyPackage.eNS_URI);

        // Obtain or create and register package
        JavaAssemblyPackageImpl theJavaAssemblyPackage = (JavaAssemblyPackageImpl) (EPackage.Registry.INSTANCE.getEPackage(eNS_URI) instanceof JavaAssemblyPackageImpl ? EPackage.Registry.INSTANCE.getEPackage(eNS_URI) : new JavaAssemblyPackageImpl());
        ...
        theJavaAssemblyPackage.createPackageContents();

        // Initialize created meta-data
        theJavaAssemblyPackage.initializePackageContents();

        // Mark meta-data to indicate it can't be changed
        theJavaAssemblyPackage.freeze();

        return theJavaAssemblyPackage;
    }
     ...
     * @generated
     */
    public JavaAssemblyFactory getJavaAssemblyFactory() {
        return (JavaAssemblyFactory) getEFactoryInstance();
    }
    ...
    public void initializePackageContentsGen() {
        ...
        javaImplementationEClass.getESuperTypes().add(theAssemblyPackage.getImplementation());
