...
/**
 * Tests integration of aggregate context and java component builders
 * 
 * @version $Rev$ $Date$
 */
public class JavaBuilderIntegrationTestCase extends TestCase {

    public JavaBuilderIntegrationTestCase(String arg0) {
        super(arg0);
    }
    ...
    public void testBuildAggregateContext() throws Exception {
