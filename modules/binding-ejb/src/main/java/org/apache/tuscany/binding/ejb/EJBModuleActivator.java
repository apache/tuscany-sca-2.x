...
public class EJBModuleActivator implements BindingActivator {

    public static final QName BINDING_EJB = new QName(Constants.SCA10_NS, "binding.ejb");
    
    public ReferenceInvokerFactory createInvokerFactory(RuntimeComponent rc, RuntimeComponentReference rcr, Binding binding) {
