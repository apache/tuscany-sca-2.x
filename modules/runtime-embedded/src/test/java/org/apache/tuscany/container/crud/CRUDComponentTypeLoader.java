 ...
 * @version $Rev$ $Date$
 */
public class CRUDComponentTypeLoader extends ComponentTypeLoaderExtension<CRUDImplementation> {

    @Constructor( {"registry"})
    public CRUDComponentTypeLoader(@Reference LoaderRegistry loaderRegistry) {
    ...
    public void load(CRUDImplementation implementation, DeploymentContext deploymentContext) throws LoaderException {
