 ...
 * @version $Rev$ $Date$
 */
public final class DomainAdminLauncherUtil {

    private final static Logger logger = Logger.getLogger(DomainAdminLauncherUtil.class.getName());
    ...
    static ClassLoader runtimeClassLoader() throws FileNotFoundException, URISyntaxException, MalformedURLException {
        ...
        String resource = DomainAdminLauncherUtil.class.getName().replace('.', '/') + ".class"; 
        URL url = DomainAdminLauncherUtil.class.getClassLoader().getResource(resource);
        if (url == null) {
