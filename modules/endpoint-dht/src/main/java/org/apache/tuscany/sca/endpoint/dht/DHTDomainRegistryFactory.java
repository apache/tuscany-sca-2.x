 ...
 * given domain
 */
public class DHTDomainRegistryFactory extends BaseDomainRegistryFactory {
    private final static String[] schemes = new String[] {"multicast", "tribes"};

    /**
     * @param extensionRegistry
     */
    public DHTDomainRegistryFactory(ExtensionPointRegistry registry) {
        super(registry);
    }

    protected EndpointRegistry createEndpointRegistry(String endpointRegistryURI, String domainURI) {
        EndpointRegistry endpointRegistry =
            new OverlayEndpointRegistry(registry, new HashMap<String, String>());
