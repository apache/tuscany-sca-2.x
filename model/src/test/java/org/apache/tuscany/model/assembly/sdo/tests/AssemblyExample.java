...
public class AssemblyExample {
    ...
    public static void main(String[] args) {
        ...
        if (args.length == 0) {
            ...
            try {
                Resource resource = resourceSet.createResource(URI.createURI("http:///My.assembly"));
                DocumentRoot documentRoot = AssemblyFactory.eINSTANCE.createDocumentRoot();
                Binding root = AssemblyFactory.eINSTANCE.createBinding();
                documentRoot.setBinding(root);
