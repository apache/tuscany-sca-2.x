 ...
 * <ul>
 * <li>{@link SCABindingImpl#getAny <em>Any</em>}</li>
 * <li>{@link SCABindingImpl#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SCABindingImpl extends BindingImpl implements SCABinding {
    ...
    protected EClass eStaticClass() {
        return AssemblyPackage.eINSTANCE.getSCABinding();
    }
    ...
    public Sequence getAny() {
        if (any == null) {
            any = new BasicESequence(new BasicFeatureMap(this, AssemblyPackage.SCA_BINDING__ANY));
        }
        return any;
    }
    ...
    public Sequence getAnyAttribute() {
        if (anyAttribute == null) {
            anyAttribute = new BasicESequence(new BasicFeatureMap(this, AssemblyPackage.SCA_BINDING__ANY_ATTRIBUTE));
        }
        return anyAttribute;
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
        if (featureID >= 0) {
            ...
            case AssemblyPackage.SCA_BINDING__ANY:
                return ((InternalEList) ((ESequence) getAny()).featureMap()).basicRemove(otherEnd, msgs);
            case AssemblyPackage.SCA_BINDING__ANY_ATTRIBUTE:
    ...
    public Object eGet(EStructuralFeature eFeature, boolean resolve) {
        ...
        case AssemblyPackage.SCA_BINDING__URI:
            return getUri();
        case AssemblyPackage.SCA_BINDING__ANY:
