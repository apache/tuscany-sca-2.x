 ...
 * <ul>
 * <li>{@link JavaInterfaceImpl#getAny <em>Any</em>}</li>
 * <li>{@link JavaInterfaceImpl#getCallbackInterface <em>Callback Interface</em>}</li>
 * <li>{@link JavaInterfaceImpl#getInterface <em>Interface</em>}</li>
 * <li>{@link JavaInterfaceImpl#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class JavaInterfaceImpl extends InterfaceImpl implements JavaInterface {
    ...
    protected EClass eStaticClass() {
        return AssemblyPackage.eINSTANCE.getJavaInterface();
    }
    ...
    public Sequence getAny() {
        if (any == null) {
            any = new BasicESequence(new BasicFeatureMap(this, AssemblyPackage.JAVA_INTERFACE__ANY));
        }
        return any;
    }
    ...
    public void setCallbackInterface(String newCallbackInterface) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, AssemblyPackage.JAVA_INTERFACE__CALLBACK_INTERFACE, oldCallbackInterface, callbackInterface));
    }
    ...
    public void setInterface(String newInterface) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, AssemblyPackage.JAVA_INTERFACE__INTERFACE, oldInterface, interface_));
    }
    ...
    public Sequence getAnyAttribute() {
        if (anyAttribute == null) {
            anyAttribute = new BasicESequence(new BasicFeatureMap(this, AssemblyPackage.JAVA_INTERFACE__ANY_ATTRIBUTE));
        }
        return anyAttribute;
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
        if (featureID >= 0) {
            ...
            case AssemblyPackage.JAVA_INTERFACE__ANY:
                return ((InternalEList) ((ESequence) getAny()).featureMap()).basicRemove(otherEnd, msgs);
            case AssemblyPackage.JAVA_INTERFACE__ANY_ATTRIBUTE:
    ...
    public Object eGet(EStructuralFeature eFeature, boolean resolve) {
        ...
        case AssemblyPackage.JAVA_INTERFACE__CALLBACK_INTERFACE:
            return getCallbackInterface();
        case AssemblyPackage.JAVA_INTERFACE__INTERFACE:
            return getInterface();
        case AssemblyPackage.JAVA_INTERFACE__ANY_ATTRIBUTE:
