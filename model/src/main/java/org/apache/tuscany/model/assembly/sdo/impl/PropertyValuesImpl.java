 ...
 * <ul>
 * <li>{@link PropertyValuesImpl#getAny <em>Any</em>}</li>
 * <li>{@link PropertyValuesImpl#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class PropertyValuesImpl extends EDataObjectImpl implements PropertyValues {
    /**
    ...
    protected EClass eStaticClass() {
        return AssemblyPackage.eINSTANCE.getPropertyValues();
    }
    ...
    public Sequence getAny() {
        if (any == null) {
            any = new BasicESequence(new BasicFeatureMap(this, AssemblyPackage.PROPERTY_VALUES__ANY));
        }
        return any;
    }
    ...
    public Sequence getAnyAttribute() {
        if (anyAttribute == null) {
            anyAttribute = new BasicESequence(new BasicFeatureMap(this, AssemblyPackage.PROPERTY_VALUES__ANY_ATTRIBUTE));
        }
        return anyAttribute;
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
        if (featureID >= 0) {
            ...
            case AssemblyPackage.PROPERTY_VALUES__ANY:
                return ((InternalEList) ((ESequence) getAny()).featureMap()).basicRemove(otherEnd, msgs);
            case AssemblyPackage.PROPERTY_VALUES__ANY_ATTRIBUTE:
