...
import static org.apache.tuscany.model.assembly.Multiplicity.ONE_N;
import static org.apache.tuscany.model.assembly.Multiplicity.ONE_ONE;
import static org.apache.tuscany.model.assembly.Multiplicity.ZERO_N;
import static org.apache.tuscany.model.assembly.Multiplicity.ZERO_ONE;
...
public class SCDLModelContentHandlerImpl extends ScdlSwitch implements ModelContentHandler {
     ...
     * Constructor
     */
    public SCDLModelContentHandlerImpl(AssemblyModelContext modelContext,
                                       List<SCDLModelLoader> scdlModelLoaders) {
     ...
     */
    public void setLinkers(List<Runnable> linkers) {
     ...
     */
    public void setTargets(Map<Object, Object> targets) {
        // the field is never used, make this a no-op 
     ...
     *
     * @param multiplicity the SDO multiplicity
     * @return the equivalent assembly model multiplicity
     */
    private static org.apache.tuscany.model.assembly.Multiplicity transformMultiplicity(Multiplicity multiplicity) {
        if (Multiplicity._01_LITERAL.equals(multiplicity))
            return ZERO_ONE;
        else if (Multiplicity._0N_LITERAL.equals(multiplicity))
            return ZERO_N;
        else if (Multiplicity._11_LITERAL.equals(multiplicity))
            return ONE_ONE;
        else if (Multiplicity._1N_LITERAL.equals(multiplicity))
            return ONE_N;
        else
            return ONE_ONE;
    }
    ...
    public Object casePropertyValues(final PropertyValues object) {
        ...
        for (int p = 0, n = sequence.size(); p < n; p++) {
            ...
            if (attrs != null && attrs.size() != 0) {
                ...
                if (attr != null && "overridable".equals(attr.getName())) {
...
*/
    ...
    public Object caseExternalService(ExternalService object) {
        ...
        if (OverrideOptions.MAY_LITERAL.equals(overrideOptions))
            externalService.setOverrideOption(OverrideOption.MAY);
        else if (OverrideOptions.MUST_LITERAL.equals(overrideOptions))
            externalService.setOverrideOption(OverrideOption.MUST);
        else if (OverrideOptions.NO_LITERAL.equals(overrideOptions))
    ...
    public Object caseModuleComponent(ModuleComponent object) {
        ...
        // the field is never used, don't save it for now 
