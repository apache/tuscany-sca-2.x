...
public class XMLNameUtil {
    ...
    public final static XMLNameUtil INSTANCE = new XMLNameUtil();
    ...
    public String getPackageNameFromNamespace(String namespace) {
        ...
        if ((namespace != null) && (namespace.startsWith("multipart:")))
     ...
     * @return
     */
    public String getNSPrefixFromPackageName(String packageName) {
     ...
     * @return
     */
    private List parseName(String sourceName, char separator) {
     ...
     * @return
     */
    public String getValidNameFromXMLName(String name, boolean isUpperCase) {
