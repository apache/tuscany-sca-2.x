 ...
 * <ul>
 * <li>{@link ReferenceValuesImpl#getAny <em>Any</em>}</li>
 * <li>{@link ReferenceValuesImpl#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ReferenceValuesImpl extends EDataObjectImpl implements ReferenceValues {
    /**
    ...
    protected EClass eStaticClass() {
        return AssemblyPackage.eINSTANCE.getReferenceValues();
    }
    ...
    public Sequence getAny() {
        if (any == null) {
            any = new BasicESequence(new BasicFeatureMap(this, AssemblyPackage.REFERENCE_VALUES__ANY));
        }
        return any;
    }
    ...
    public Sequence getAnyAttribute() {
        if (anyAttribute == null) {
            anyAttribute = new BasicESequence(new BasicFeatureMap(this, AssemblyPackage.REFERENCE_VALUES__ANY_ATTRIBUTE));
        }
        return anyAttribute;
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
        if (featureID >= 0) {
            ...
            case AssemblyPackage.REFERENCE_VALUES__ANY:
                return ((InternalEList) ((ESequence) getAny()).featureMap()).basicRemove(otherEnd, msgs);
            case AssemblyPackage.REFERENCE_VALUES__ANY_ATTRIBUTE:
